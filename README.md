...
- 同期・ジョブ・AI 予算の状態は Settings。残量メーターは「なくなったら追加」。公式残量は `X_BEARER_TOKEN` か App の client credentials。無いときは同期記録から 24 時間重複を除いて見積もる。
